...
"""
df = pd.read_csv('BadIngredients/ingredients_restricted.csv') #restricted ingredients
...
sql_insert = '''
    INSERT INTO badingredients(chemical_name,ingredient_name,explanation,source) 
        VALUES (?,?,'Restricted', 'https://ec.europa.eu/growth/tools-databases/cosing/pdf/COSING_Annex%20III_v2.csv')
'''
