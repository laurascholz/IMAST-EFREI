...
"""
df = pd.read_csv('BadIngredients/ingredients_preservatives.csv') #preservatives ingredients
...
sql_insert = '''
    INSERT INTO badingredients(chemical_name,ingredient_name,explanation,source) 
        VALUES (?,?,'Preservatives', 'https://ec.europa.eu/growth/tools-databases/cosing/pdf/COSING_Annex%20V_v2.csv')
'''
